...
export default class Actfour extends Component{
    constructor(props){
        super(props);
        this.state={
            setClose:true
                    ...
                    <View style={styles.setBox}>
                        ...
                        <View style={styles.intoBox}>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>1--6</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>7--12</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>13--18</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>19--24</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
