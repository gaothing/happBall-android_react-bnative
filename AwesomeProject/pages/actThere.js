...
export default class Actthere extends Component{
    constructor(props){
        super(props);
        this.state={
            setClose:true
                    ...
                    <View style={styles.setBox}>
                        ...
                        <View style={styles.intoBox}>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>1--3</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>4--6</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>7--9</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>10--12</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>13--15</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>16--18</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>19--21</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>22--24</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}></Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                        </View>
