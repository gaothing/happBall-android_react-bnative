...
export default class Actsix extends Component{
    constructor(props){
        super(props);
        this.state={
            setClose:true
                    ...
                    <View style={styles.setBox}>
                        ...
                        <View style={styles.intoBox}>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>1</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                                <Image style={styles.haschoosed} source={require('../list/openball/numberchoice_picture.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>2</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>3</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>4</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>5</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>6</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>7</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>8</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>9</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>10</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>11</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>12</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>13</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>14</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>15</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>16</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>17</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>18</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>19</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>20</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>21</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>22</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>23</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                            <View style={styles.list}>
                                <Text style={styles.list_nub}>24</Text>
                                <Image style={styles.list_line} source={require('../list/openball/number_Separate.png')} />
                            </View>
                        </View>
